    ...
    <div id="content" class="container pb-3">
        ...
        <div class="d-flex align-items-center-justify-content center">
            ...
            <a href="{{ route('home') }}" class="btn btn-sm fw-bold fs-4 btn-dark">
                {{-- Tombol kembali dengan warna hitam (btn-dark) --}}
        ...
        <div class="row my-3">
            <div class="col-8">
                {{-- div class col-8 untuk mengatur tata letak kolom untuk artikel detail tugas --}}
                <!-- Card utama untuk menampilkan detail tugas -->
                <div class="card" style="height: 80vh; max-height: 80vh;">
                    <div class="card-header d-flex align-items-center justify-content-between overflow-hidden">
                        <!-- Judul tugas dengan teks terpotong jika terlalu panjang -->
            ...
            <div class="col-4">
                {{-- div class col-4 yang dapat digunakan untuk informasi tambahan atau komentar --}}
